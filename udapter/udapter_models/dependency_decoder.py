...
from udapter.udapter_models.bilinear_matrix_attention import BilinearMatrixAttentionWithPGN
from udapter.udapter_models.feedforward import FeedForwardWithPGN
from udapter.udapter_models.linear import BilinearWithPGN
...
@Model.register("udapter_dependency_decoder")
class DependencyDecoder(Model):
    ...
    def __init__(self,
                 ...
                 tag_feedforward: FeedForwardWithPGN = None,
                 arc_feedforward: FeedForwardWithPGN = None,
        ...
        self.head_arc_feedforward = arc_feedforward or \
                                        FeedForwardWithPGN(png_params_dim,
                                                    encoder_output_dim, 1,
                                                    arc_representation_dim,
                                                    Activation.by_name("elu")())
        self.child_arc_feedforward = copy.deepcopy(self.head_arc_feedforward)

        self.arc_attention = BilinearMatrixAttentionWithPGN(png_params_dim,
                                                        arc_representation_dim,
                                                        arc_representation_dim,
        ...
        self.tag_bilinear = BilinearWithPGN(png_params_dim,
                                                        tag_representation_dim,
                                                        tag_representation_dim,
                                                        num_labels)
    ...
    def forward(self,  # type: ignore
        ...
        head_arc_representation = self._dropout(self.head_arc_feedforward(encoded_text, pgn_vector))
        child_arc_representation = self._dropout(self.child_arc_feedforward(encoded_text, pgn_vector))

        # shape (batch_size, sequence_length, tag_representation_dim)
        head_tag_representation = self._dropout(self.head_tag_feedforward(encoded_text, pgn_vector))
        child_tag_representation = self._dropout(self.child_tag_feedforward(encoded_text, pgn_vector))
        # shape (batch_size, sequence_length, sequence_length)
        attended_arcs = self.arc_attention(head_arc_representation,
                                           child_arc_representation, pgn_vector)
    ...
    def _construct_loss(self,
                        ...
                        mask: torch.Tensor,
                        pgn_vector: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        """
        ...
        head_tag_logits = self._get_head_tags(head_tag_representation, child_tag_representation, head_indices, pgn_vector)
    ...
    def _mst_decode(self,
        ...
        pairwise_head_logits = self.tag_bilinear(head_tag_representation, child_tag_representation, pgn_vector)
    ...
    def _get_head_tags(self,
                       ...
                       child_tag_representation: torch.Tensor,
                       head_indices: torch.Tensor,
                       pgn_vector: torch.Tensor) -> torch.Tensor:
        """
        ...
        head_tag_logits = self.tag_bilinear(selected_head_tag_representations,
                                            child_tag_representation, pgn_vector)
